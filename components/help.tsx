            ...
            <AlertDialog open={isOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader className="flex flex-row items-center justify-end">
                        <Button variant="outline" className="w-fit h-fit p-3" onClick={() => {
                        setIsOpen(!isOpen);
                    }}>
                            <X className="w-4 h-4" />
                        </Button>
                    </AlertDialogHeader>
                    <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">1. 유튜브용 애드 블록 설치</h4>
                    <div className="flex flex-row items-center gap-2">
                        ...
                        >
                            <Button variant="outline" className="p-3 gap-2">
                                유튜브용 애드 블록<Link className="w-4 h-4"/>
                            </Button>
                        </a>
                    </div>
                    <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">2. 확장 프로그램 설정</h4>
                    ...
                    <Image src={Img1} className="w-full object-contain" alt="img-2-1"/>
                    <p className="text-sm font-semibold">
                        2-2. 시크릿 모드에서 허용
                    </p>
                    <Image src={Img2} className="w-full" alt="img-2-2"/>
                    <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">3. 페이지 새로고침</h4>
                    <div className="flex flex-row items-center gap-2">
                        <Button variant="outline" className="p-3 gap-2" onClick={()=>{location.reload()}}>
                            새로고침<RotateCcw className="w-4 h-4"/>
                        </Button>
                    </div>
                </AlertDialogContent>
            </AlertDialog>
